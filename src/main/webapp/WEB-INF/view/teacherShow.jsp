...
<body>
       ...
       <br>
       <center><font style="font-size:28px;font-family: sans-serif">权威教练</font></center>
           <ul class="ul-list" id="ul-list">
             ...
             <div class="jkpt-list-left"><a target="_blank" href="/look/coach/getnamecoach.htm?cid=${coach.cid}"><img src="${coach.cphoto}" title="${coach.cname}教练"></a>
                 ...
                 <div class="jkpt-list-center">
                     ...
                     <div class="address"><span><a target="_blank" href="/look/driverschool/getonedriverschool.htm?did=${coach.did}">${coach.dname}</a></span></div>
		...
		function nextpage(){
			...
			$.post('/look/coach/paginationcoach.htm',{
				...
				for(var i=0;i<data.length;i++){
					$('#ul-list').append('<li><div class="jkpt-list-left"><a target="_blank" href="/look/coach/getnamecoach.htm?cid='+data[i].cid+'"><img src="'+data[i].cphoto+'" title="'+data[i].cname+'"></a></div><div class="jkpt-list-center"><div class="title"><a href="/look/coach/getnamecoach.htm?cid='+data[i].cid+'">'+data[i].cname+' </a>&nbsp;&nbsp;&nbsp;&nbsp;<span class="age">教龄'+data[i].c2+'年</span></div><div class="address"><span><a target="_blank" href="/look/driverschool/getonedriverschool.htm?did='+data[i].did+'">'+data[i].dname+'</a></span></div><div class="jtaddress"><span>地址：'+data[i].caddress+' </span></div><div class="score"><span>驾校评分：'+data[i].cscore+'</span></div></div><div style="float:right;margin-top: 14px;"><p><font style="font-size:28px;font-family: sans-serif;color: red"><strong ><i >￥</i>'+data[i].c1+'</strong></font><span><font size="2px">起</font></span></p></div><br><br><div style="height:0; clear:both;" ></div></li>');
